...
export const InvestorDashboard = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        setLoading(true);
        const [entrepreneursData, connectionsData] = await Promise.all([
          fetchEntrepreneurs(),
  ...
  const acceptedConnectionsCount = connections.filter(conn => conn.status === 'accepted').length;
          ...
          <CardBody>
            <div className="flex items-center">
              ...
              <div>
                ...
                <h3 className="text-xl font-semibold text-blue-900">{entrepreneurs.length}</h3>
              </div>
            </div>
          </CardBody>
        </Card>
